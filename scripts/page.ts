...
import { biggestSwing, stateCurve } from '../src/analysis/curve.ts';
import { normaliseRole } from '../src/analysis/metrics.ts';
import { deathsOf, describeDeath } from '../src/analysis/moments.ts';
import {
  type DeathDot,
  deathMapSvg,
  goldCurveSvg,
...
import { DEFAULT_DB_PATH, openDb } from '../src/store/db.ts';
import {
  findAccount,
  getRawMatch,
  getRawTimeline,
...
const [, , accountArg = 'smurf', gamesArg = '10', roleArg = 'mid'] = process.argv;
